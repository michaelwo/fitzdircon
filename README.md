...
- An iFit fitness console running GlassOS (treadmill or exercise bike)
...
| `:lib:dircon` | Zwift Direct Connect server — mDNS registration, TCP listener, FTMS/GATT-over-TCP protocol |
